...
public class ShootTwoBalls extends SequentialCommandGroup {
  ...
  public ShootTwoBalls(Supplier<SuppliedRPM> rpmSupplier, Command runSimultaneously, boolean two) {
    addCommands(
    ...
    if (two) {
      ...
      addCommands(new LoadBallIntoStorageUntilLoaded(storageSubsystem).withTimeout(1));
    }
  }

  public ShootTwoBalls(Supplier<SuppliedRPM> rpmSupplier, Command runSimultaneously) {
    this(rpmSupplier, runSimultaneously, true);
  }
